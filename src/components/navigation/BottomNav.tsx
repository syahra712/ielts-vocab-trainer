...
const ALL_DESKTOP = [
  ...
  },
  {
    href: '/writing',
    label: 'Writing',
    icon: MOBILE_NAV[1].icon,
  },
  {
    href: '/reading',
    label: 'Reading',
    icon: MOBILE_NAV[2].icon,
  },
  {
    href: '/listening',
    label: 'Listening',
    icon: MOBILE_NAV[3].icon,
  },
  {
    href: '/speaking',
    label: 'Speaking',
    icon: MOBILE_NAV[4].icon,
  },
  {
    href: '/progress',
    label: 'Progress',
    ...
    <>
      ...
      <nav className="fixed left-0 top-0 z-50 hidden h-full w-64 border-r border-[#ededec] bg-[#fcfcfb] md:block">
        <div className="px-6 py-8">
          <h1 className="text-[18px] font-medium text-[#1a1a2e]">IELTS Prep</h1>
          <p className="text-[11px] text-[#b0b0b8]">Band 8+ trainer</p>
        </div>
        <div className="flex flex-col gap-1 px-3">
          {ALL_DESKTOP.map((item) => {
            const active =
      ...
      {/* Mobile bottom nav — 5 tabs: Home + 4 IELTS skills */}
